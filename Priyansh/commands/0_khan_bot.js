...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️𝐇𝐌𝐌 𝐇𝐌𝐌 𝐊𝐀𝐑𝐓𝐄 𝐇𝐎 𝐏𝐈𝐂𝐇𝐋𝐄 𝐙𝐍𝐀𝐌 𝐌𝐄 𝐁𝐇𝐀𝐈𝐒 𝐓𝐇𝐄 𝐊𝐈𝐘𝐀 🙈", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "khan") || (event.body.toLowerCase() == "khan bhai")) {
     return api.sendMessag("KHAN BOSS ABHI APNI WIFE AYESHA KE SATH BUJI HAI KIYA KAAM H MUJHE BTAO ME BOSS KO BTA DUNGI", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😎") || (event.body.toLowerCase() == "😎")) {
     return api.sendMessage("𝐂𝐇𝐀𝐒𝐇𝐌𝐀 𝐇𝐓𝐀𝐈𝐘𝐄 𝐍𝐀 𝐒𝐈𝐑 𝐊𝐈𝐘𝐀 𝐍𝐀𝐌𝐄 𝐇𝐀𝐈 𝐀𝐀𝐏𝐊𝐀🤣", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "🤖") || (event.body.toLowerCase() == "🤖")) {
   ...
   if ((event.body.toLowerCase() == "😷") || (event.body.toLowerCase() == "😷") || (event.body.toLowerCase() == "😷") || (event.body.toLowerCase() == "😷")) {
     return api.sendMessage("️𝐊𝐘𝐀 𝐇𝐔𝐀 𝐊𝐑𝐎𝐍𝐀 𝐕𝐀𝐈𝐑𝐀𝐒 𝐅𝐈𝐑 𝐒𝐄 𝐂𝐇𝐀𝐋𝐔 𝐇𝐎 𝐆𝐘𝐀 𝐇𝐀𝐈 𝐊𝐈𝐘𝐀 😇", threadID);
   };

   if ((event.body.toLowerCase() == "😒😒") || (event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒😒😒")) {
    return api.sendMessage("️️️😒😒😒😒👈", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "🙃") || (event.body.toLowerCase() == "🙃🙃")) {
     return api.sendMessage("️𝐀𝐑𝐄 𝐃𝐄𝐊𝐇𝐎 𝐌𝐄𝐑𝐀 𝐁𝐀𝐁𝐔 𝐔𝐋𝐓𝐀 𝐇𝐎 𝐆𝐘𝐀 𝐊𝐎𝐈 𝐒𝐈𝐃𝐇𝐀 𝐊𝐑𝐎😝", threadID);
   };
